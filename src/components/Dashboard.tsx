  ...
  return (
    <div className="space-y-6 min-h-screen">
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl p-8 text-white">
        ...
        <p className="text-blue-100 text-lg">Your intelligent academic resource hub for sharing and discovering study materials</p>
      </div>
      ...
      <SearchFilters searchQuery={searchQuery} onSearchChange={setSearchQuery} selectedCategory={selectedCategory} onCategoryChange={setSelectedCategory} selectedDepartment={selectedDepartment} onDepartmentChange={setSelectedDepartment} customDepartment={customDepartment} onCustomDepartmentChange={setCustomDepartment} />
...
const StatCard = ({ icon, bg, value, label }: { icon: JSX.Element; bg: string; value: number | string; label: string }) => (
